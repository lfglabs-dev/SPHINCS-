...
- `SegmentAcceptSpec.LayerGuardedStep`,
  ...
  `SegmentLayer3.beforeWotsDigestCountOff_eq`,
  `SegmentLayer3.beforeWotsDigestCountOff_sigOff_lookup_eq`,
  `SegmentLayer3.beforeWotsDigestCountOff_sigBase_lookup_eq`,
  `SegmentLayer3.beforeWotsDigestAdrsSlot_countOff_lookup_eq`,
  ...
  `SegmentLayer3.beforeWotsDigestAdrsSlot_count_lookup_eq_shifted_calldata`,
  `SiblingCalldata.shifted_sig_read_eq_readBE4`,
  `SiblingCalldata.parseSignatureC13_layer_count_eq_readBE4`,
  `SiblingCalldata.parseSignatureC13_layer_count_eq_shifted_calldata`,
  ...
  `SegmentLayer3.afterMerkle_authOff_lookup_eq`,
  `SegmentLayer3.finalLayerTail_sigOff_lookup_eq`,
