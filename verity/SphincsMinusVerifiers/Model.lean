...
def c13VerifyBody : List Stmt := [
  ...
  .ite (andE (shrE (u 114) (v "dVal")) (u 0x7FFFF)) returnFalse [],
  .letVar "sigBase" (v "sig_data_offset"),
  .letVar "idxLeaf0" (andE (v "htIdx") (u 0x7FF)),
  .letVar "idxTree0" (shrE (u 11) (v "htIdx")),
  .letVar "forsBase" (orE (shlE (u 128) (v "idxTree0")) (orE (shlE (u 96) (u 3)) (shlE (u 64) (v "idxLeaf0")))),
  ...
  .forEach "layer" (u 2) [
    ...
    .ite (notE (eqE (v "digitSum") (u 208))) returnFalse [],
